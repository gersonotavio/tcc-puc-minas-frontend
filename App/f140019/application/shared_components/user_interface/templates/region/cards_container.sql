...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(4035076450157557)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(206552579000582)
,p_plug_template_id=>wwv_flow_imp.id(4035076450157557)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(206569013000583)
,p_plug_template_id=>wwv_flow_imp.id(4035076450157557)
,p_name=>'Sub Regions'
